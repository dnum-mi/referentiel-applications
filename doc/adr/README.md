...
| N°   | Titre                                                                                                           | Statut  |
| ---- | --------------------------------------------------------------------------------------------------------------- | ------- |
| 0001 | Enregistrer les décisions d'architecture _(socle ADR partagé)_                                                  | Accepté |
| 0002 | Utiliser Apache Superset pour la datavisualisation _(socle ADR partagé)_                                        | Accepté |
...
> Les ADR **0001** et **0002** relèvent du socle ADR partagé du dépôt (`record-architecture-decisions` et `dataviz-superset`) ; ils sont maintenus indépendamment de cette contribution documentaire.
