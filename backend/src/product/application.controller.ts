...
import { ApiTags, ApiOperation, ApiBody, ApiCreatedResponse, ApiOkResponse, ApiForbiddenResponse, ApiAcceptedResponse, ApiNotFoundResponse, ApiNoContentResponse, ApiQuery } from "@nestjs/swagger";
...
- **compliances**: La liste des conformités associées avec :
  ...
  @ApiQuery({
    type: ApplicationSearchDto,
    description: "Paramètres de recherche et de filtrage des applications.",
  })
  async search(
